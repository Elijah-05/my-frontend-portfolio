                ...
                <div className="sm:flex items-center ">
                    ...
                    <div className="">
                        <p className='sm:text-justify'>
                            <span className='hidden lg:inline'>I Graduated in Civil Engineering from Jimma institute of Technology. I am interested in Technologies and relateds, so I have shifted my career to Technology fields.</span> I am a self-driven fast-learner junior <span className=' text-secondaryColor font-medium hover:opacity-80'>Front-end Developer</span> and have been practicing a real world projects. My working life has been dedicated to designing and developing interactive websites. In addition, I have also received  <a href='https://www.freecodecamp.org/certification/fccb7c2c749-f4c9-4e3e-876d-cab8bf2cf164/front-end-development-libraries' className=' text-primaryColor hover:opacity-80'>Frontend Web Development Certification</a> from freecodecamp. I am also talented senior <span className=' text-secondaryColor font-medium hover:opacity-80'>Graphic Designer</span> having more than Two years of experience.
                        </p>
                    </div>
                </div>
            </div>
