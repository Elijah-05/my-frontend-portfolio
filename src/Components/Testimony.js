            ...
            <div className="max-w-5xl mx-auto text-center w-11/12 ">
                ...
                <div className="flex flex-col md:flex-row sm:justify-evenly mx-auto">
                    {testimonialData.map(data => 
                        <div className="bg-gray-100 p-5 flex flex-col items-center justify-between my-2 rounded-xl lg:max-w-md  sm:mx-3 md:shadow-lg hover:scale-105 duration-300 shadow-md hover:shadow-xl text-black" key={data.name}>
                            <div className="">
